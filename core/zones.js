...
function levelUp() {
    ...
    var pool = RELICS.filter(function(r) {
        ...
        if (r.bossRelic) {
            ...
            var bossId = null;
            var bossMap = {piuma:"corvo",occhiolupo:"lupo",linguarospo:"rospo",coronatiranno:"tiranno",scagliadraga:"draga",frammentovuoto:"vuoto",pelleprimordiale:"primordiale",setabruchi:"bruchi",pioggiammele:"newton",piumagufo:"gufo",cornosaggezza:"cervo",gusciolumaca:"lumaca",scagliecocco:"coccodrillo",calzinolep:"leprecauno",linguamimic:"mimic",cristallobasi:"basilisco",piumafenice:"fenice",nebbianebula:"nebula",pulsar:"astro",irideabisso:"occhio",ilnome:"entita"};
            bossId = bossMap[r.id];
...
function showGameOver() {
    ...
    if (typeof incrementCompletedRuns === "function") incrementCompletedRuns();
    if (typeof hideMobileControls === "function") hideMobileControls();
    closePauseRelicPanel();
    if (codexFab) codexFab.style.display = "none";
    if (codexPanel) { codexPanel.classList.remove('open'); document.body.classList.remove('codex-open'); codexIsOpen = false; }
