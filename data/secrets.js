/* ===== SHOP SEGRETO BUFFS ===== */
var SECRET_BUFFS = [
    { id: "cuore_antico", name: "Cuore dell'Antico", icon: "🫀", desc: "I tuoi cuori massimi diminuiscono di 1, ma ogni 5 mele mangiate ne recuperi uno.", cost: { seg: 2, hp: 1 }, fn: function(g) { g.hpMaxMod = (g.hpMaxMod || 0) - 1; g.hp = Math.max(1, g.hp - 1); g.cuoreAntico = true; g.cuoreAnticoMeals = 0; } },
    ...
    { id: "fame_eterna", name: "Fame Eterna", icon: "💀", desc: "Ogni mela mangiata infligge danno a tutti i nemici entro 3 celle. Ma perdi 1 punto vita massimo.", cost: { seg: 4, hp: 1 }, fn: function(g) { g.fameEterna = true; g.hpMaxMod = (g.hpMaxMod || 0) - 1; g.hp = Math.max(1, g.hp - 1); } }
];
